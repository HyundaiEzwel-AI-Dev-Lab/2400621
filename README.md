...
- `docs/02_screen_spec.md`[🔗](docs/02_screen_spec.md)
- `docs/03_api_spec.md`[🔗](docs/03_api_spec.md)
- `docs/04_db_design.md`[🔗](docs/04_db_design.md)
- `docs/05_component_design.md`[🔗](docs/05_component_design.md)
...
| --- | --- | --- | --- |
| 1️⃣ Phase1 | 실행 골격과 최소 기능 구성 | Backend/Frontend/Docker/DB/API 기본 연동 | `docs/07_phase1_review.md`[🔗](docs/07_phase1_review.md) |
| 2️⃣ Phase2 | 명세와 구조 정합화 | API query/paging 보완, JPA 전환, UX 일부 개선 | `docs/08_phase2_review.md`[🔗](docs/08_phase2_review.md) |
| 3️⃣ Phase3 | 화면 흐름과 테스트 보강 | Vitest 도입, placeholder 화면, 접근성 동작 보완 | `docs/09_final_function_review.md`[🔗](docs/09_final_function_review.md) |
| 🎨 Phase3 이후 | UI 사용성 보완 | 캘린더 막대, 상세 팝업, 반응형, breadcrumb 정리 | `docs/worklog.md`[🔗](docs/worklog.md) |
...
| 단계 | 산출물 | 목적 |
| --- | --- | --- |
| 🧭 Context | `docs/00_project_context.md`[🔗](docs/00_project_context.md) | 기술 스택과 개발 원칙 고정 |
| 📄 Requirements | `docs/01_requirements.md`[🔗](docs/01_requirements.md) | PPTX 기반 요구사항 분석 |
| 🧩 Design | `docs/02_screen_spec.md`[🔗](docs/02_screen_spec.md) | 화면 구조와 UX 정의 |
| 🧩 Design | `docs/03_api_spec.md`[🔗](docs/03_api_spec.md) | REST API 명세 |
| 🧩 Design | `docs/04_db_design.md`[🔗](docs/04_db_design.md) | DB 모델과 ERD 기준 |
| 🧩 Design | `docs/05_component_design.md`[🔗](docs/05_component_design.md) | Frontend 컴포넌트 구조 |
| 🗺️ Planning | `docs/06_implementation_plan.md`[🔗](docs/06_implementation_plan.md) | Phase별 구현 계획 |
| 🔍 Review | `docs/07_phase1_review.md`[🔗](docs/07_phase1_review.md) | Phase1 검증 |
| 🔍 Review | `docs/08_phase2_review.md`[🔗](docs/08_phase2_review.md) | Phase2 검증 |
| 🔍 Review | `docs/09_final_function_review.md`[🔗](docs/09_final_function_review.md) | 최종 기능 검증 |
| 🤖 Methodology | `docs/11_vibecoding_methodology.md`[🔗](docs/11_vibecoding_methodology.md) | Vibe Coding 방법론 정리 |
| 📊 Report | `docs/12_poc_report.md`[🔗](docs/12_poc_report.md) | PoC 결과 보고 |
| 🛠️ Operation | `docs/worklog.md`[🔗](docs/worklog.md) | 작업 이력 |
| 🛠️ Operation | `docs/issues.md`[🔗](docs/issues.md) | 이슈 관리 |
| 📌 Assumption | `assumptions.md`[🔗](assumptions.md) | 적용 전제 기록 |
...
검증 중 실패한 항목은 **원인을 분석하고 수정한 뒤 재실행**했다. 결과는 `docs/worklog.md`[🔗](docs/worklog.md), `docs/issues.md`[🔗](docs/issues.md), Phase별 review 문서에 기록했다.
